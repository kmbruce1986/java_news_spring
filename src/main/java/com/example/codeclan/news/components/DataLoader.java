...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args){
        ...
        LocalDateTime date4 = LocalDateTime.of(2017, Calendar.NOVEMBER, 15, 17, 05, 00);
        LocalDateTime date5 = LocalDateTime.of(2017, Calendar.SEPTEMBER, 8, 04, 10, 00);
        ...
        Article article4 = new Article("Sunrise? Wat Sunrise", "Unbelievable views at Angkor Wat", copy3, "angkor_banner.jpg", "angkor_thumb.jpg", date5, category3, loisLane);
        articleRepository.save(article4);

        Article article5 = new Article("Tokyo Robots", "Gundam, Help Desks and Restaurants", copy4, "robot_banner.jpg", "robot_thumb.jpg", date4, categories4, loisLane);
